...
<div class="container-master">
    ...
    <div class="container-hr">
        <p>Jogos na conta: <?php echo $g - 1 ?></script>
        </p>
        <hr>
    </div>
    ...
    function clickGame() {
        ...
        for (var i = 1; i < count; i++) {
            if (game == "gameName" + i || game == "gameAuthor" + i || game == "gameDate" + i || game == "gameSize" + i || game == "container-games" + i || game == "gameImg" + i) {
                ...
                document.getElementById("container-games" + i).style.backgroundColor = "var(--cor-retoques)";
            } else {
                document.getElementById("container-games" + i).style.backgroundColor = "var(--cor-secundaria)";
            }
        }
    }
</script>
